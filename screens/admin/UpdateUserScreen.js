...
const UpdateUserScreen = () => {
  ...
  const [role, setRole] = useState(user.role.role ? user.role.role : "");
  const [status, setStatus] = useState(user.isActive ? user.isActive : false);
    ...
    <ScrollView>
      <View style={{ padding: 10 }}>
        ...
        <KeyboardAvoidingView>
          ...
          <SelectDropdown
            data={roles}
            defaultValueByIndex={roles.indexOf(role)}
            buttonStyle={{
              width: "100%",
              marginVertical: 5,
              borderColor: "black",
          ...
          <SelectDropdown
            ...
            defaultValueByIndex={["Active", "Inactive"].indexOf(
